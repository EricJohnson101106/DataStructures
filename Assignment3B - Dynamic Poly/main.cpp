...
int main() {
    cout << "Constructing a EJDynamicPoly object" << endl;
    colorado_edu::EJDynamicPoly test1;
    ...
    cout << "Constructing a second EJDynamicPoly object" << endl;
    colorado_edu::EJDynamicPoly test2;
...
//ADDITION
    ...
    colorado_edu::EJDynamicPoly addOpTest = (test1 + test2);
...
//SUBTRACTION
    ...
    colorado_edu::EJDynamicPoly subOpTest = (test1 - test2);
    ...
    cout << "\n===================================================\n" << endl;
//MULTIPLICATION
    colorado_edu::EJDynamicPoly multiOpTest = (test1 * test2);
...
//TESTING next_term and previous_term
    cout << "Initialize EJDynamicPoly: 6x^6 + 4x^4 + 2x^2 + 1" << endl;
    colorado_edu::EJDynamicPoly test3;
    ...
    cout << "\n==========================================================\n" << endl;
    cout << "Testing increasing array" << endl;
    colorado_edu::EJDynamicPoly test4(5.0, 33);
    cout << "Current degree after constructing to 33: " << test4.degree() << endl;
    test4.add_to_coef(5.0, 35);
    cout << "Current degree after adding 5 to coefficient 35: " <<  test4.degree() << endl;
